...
if(strlen($problem->input_sample)>0) $tabs[$attrs['input_sample']]='<pre style="border: 1px solid blue;font-family: \'Courier New\', Courier, monospace;">'.($model->input_sample)."\r\n".'</pre>';
if(strlen($problem->output_sample)>0) $tabs[$attrs['output_sample']]='<pre style="border: 1px solid blue;font-family: \'Courier New\', Courier, monospace;">'.($model->output_sample)."\r\n".'</pre>';
