...
class OrganizationController extends Controller
{
	...
	public function actionReturnForm(){
		...
		if(isset($_POST['update_id']))$model= $this->loadModel($_POST['update_id']);else $model=new Organization;
	...
	public function actionCreateRoot()
	{
		...
		if(isset($_POST['Organization']))
		{
			...
			$new_root=new Organization;
			$new_root->attributes=$_POST['Organization'];
			...
			{
				echo json_encode(array('success'=>false,
						'message'=>'Error.Root Organization was not created.'
				)
				);
				exit;
			}
	...
	public function actionCreate(){
		...
		if(isset($_POST['Organization']))
		{
			...
			{
				echo json_encode(array('success'=>false,
						'message'=>'Error.Organization was not created.'
				)
				);
				exit;
			}
	...
	public function actionMoveCopy(){
		...
		if ($new_parent_root_id!='root') {
			...
			//else if it is a copy
				...
				//create the copied Organization model
				$copied_node=new Organization;
